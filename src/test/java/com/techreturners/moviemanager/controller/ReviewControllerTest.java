...
public class ReviewControllerTest {
    @Mock
    private ReviewServiceImpl mockReviewServiceImpl;
    ...
    public void testGetAllReviewsReturnsReviews() throws Exception {
        ...
        when(mockReviewServiceImpl.getAllReviews()).thenReturn(reviews);
    ...
    public void testGetMappingGetReviewById() throws Exception {
        ...
        when(mockReviewServiceImpl.getReviewById(review.getId())).thenReturn(review);
    ...
    public void testPostMappingAddAReview() throws Exception {
        ...
        when(mockReviewServiceImpl.insertReview(review)).thenReturn(review);
        ...
        verify(mockReviewServiceImpl, times(1)).insertReview(review);
    }
    ...
    public void testPutMappingUpdateAReview() throws Exception {
        ...
        verify(mockReviewServiceImpl, times(1)).updateReviewById(review.getId(), review);
    }
    ...
    public void testDeleteMappingDeleteAReview() throws Exception {
        ...
        verify(mockReviewServiceImpl, times(1)).deleteReviewById(review.getId());
    }
}
